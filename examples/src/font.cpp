...
int main()
{
    ...
    while (!window.shouldClose())
    {
        ...
        font.drawText(window, "Font rendering example", { -0.8f, 0.4f, 0.0f }, { 0.9f, 0.2f, 0.3f, 1.0f }, 1.0f);
        font.drawText(window, "This is some text rendered in OpenGL.", { -1.0f, 0.0f, 0.0f }, { 1.0f, 1.0f, 1.0f, 1.0f }, 0.7f);
        font.drawText(window, "The color of text can be changed too!", { -0.5f, -0.4f, 0.0f }, { 0.1f, 0.5f, 1.0f, 1.0f }, 0.5f);
        font.drawText(window, "This is a \nNewline demo", { -0.9f, -0.7f, 0.0f }, { 0.7f, 0.8f, 0.0f, 1.0f }, 0.6f);
